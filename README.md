# Calculadora Indice Global para Corredores
...
2. Insira os dados necessários (tempo, idade, sexo, distância) nos campos apropriados.
3. Clique no botão para calcular a nota ou o tempo.
